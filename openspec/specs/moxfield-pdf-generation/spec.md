# moxfield-pdf-generation Specification

## Purpose
Defines requirements for Moxfield cardback mapping, combining downloaded cards with optional local cards, and generating standard PDFs from Scryfall downloads and local selections.
