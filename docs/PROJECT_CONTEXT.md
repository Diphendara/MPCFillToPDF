...
- `src/deck_importer.py`, `src/scryfall.py`, `src/*_scraper.py`: importación de Magic, One Piece, Riftbound y Lorcana.
...
La CI prueba Python 3.10–3.13 en Ubuntu. El workflow de build genera artefactos para Windows, macOS y Linux con Python 3.11.
